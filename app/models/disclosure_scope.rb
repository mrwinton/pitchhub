class DisclosureScope
  ...
  embedded_in :comment_content_scope, class_name: "PitchCard", inverse_of: "content_scope"
  # embedded_in :pitch_card, inverse_of "pitch_card_scope"
  # embedded_in :comment, inverse_of "author_scope"
  # embedded_in :comment, inverse_of "content_scope"
